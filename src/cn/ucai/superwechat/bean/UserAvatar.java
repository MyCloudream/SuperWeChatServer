...
public class UserAvatar {
	...
	public String toString() {
		return "UserAvatar [muserName=" + muserName + ", muserPassword=" + muserPassword + ", muserNick=" + muserNick
				+ ", muserUnreadMsgCount=" + muserUnreadMsgCount + ", mavatarId=" + mavatarId + ", mavatarUserName="
				+ mavatarUserName + ", mavatarPath=" + mavatarPath + ", mavatarType=" + mavatarType
